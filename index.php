...
?>
                        ...
                        <div class="col-1-box">
                            <div class="col-1-items swiper">
                                <div class="col-1-wrapper swiper-wrapper">
                                    ...
                                    ?>
                                    <div class="col-1-item swiper-slide" id="1">
                                        <a href="" class="col-1-item__img">
                                            <img src="./assets/img/product/dc73063978e68480333f7fd85f3c445d.png" alt="">
                                        </a>
                                        <a href="" class="col-1-item__name">Фруктовый микс</a>
                                        <p class="col-1-item__description">
                                            Напитки «Приятный день» с содержанием сока
                                        </p>
                                    </div>
                                    <div class="col-1-item swiper-slide" id="2">
                                        <a href="" class="col-1-item__img">
                                            <img src="./assets/img/product/dc73063978e68480333f7fd85f3c445d.png" alt="">
                                        </a>
                                        <a href="" class="col-1-item__name">Фруктовый микс</a>
                                    ...
                                    <div class="col-1-item swiper-slide" id="3">
                                        <a href="" class="col-1-item__img">
                                            <img src="./assets/img/product/dc73063978e68480333f7fd85f3c445d.png" alt="">
                                        </a>
                                        <a href="" class="col-1-item__name">Фруктовый микс</a>
                                    ...
                                    <div class="col-1-item swiper-slide" id="4">
                                        <a href="" class="col-1-item__img">
                                            <img src="./assets/img/product/dc73063978e68480333f7fd85f3c445d.png" alt="">
                                        </a>
                                        <a href="" class="col-1-item__name">Фруктовый микс</a>
                                    ...
                                    <div class="col-1-item swiper-slide" id="5">
                                        <a href="" class="col-1-item__img">
                                            <img src="./assets/img/product/dc73063978e68480333f7fd85f3c445d.png" alt="">
                                        </a>
                                        <a href="" class="col-1-item__name">Фруктовый микс</a>
                                    ...
                                    <div class="col-1-item swiper-slide" id="6">
                                        <a href="" class="col-1-item__img">
                                            <img src="./assets/img/product/dc73063978e68480333f7fd85f3c445d.png" alt="">
                                        </a>
                                        <a href="" class="col-1-item__name">Фруктовый микс</a>
    ...
    <script src="./component/footer/index.js"></script>
